  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full text-center gap-5">
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700 dark:text-amber-50">Tasa del día: <span className="text-amber-500  rounded-2xl px-2 py-1 ml-1 font-bold shadow">Bs 216,50</span></h2>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center w-full gap-6 border-0">
          {
            menuDia.slice( 0, maxMenu ).map( ( item ) => (
              <div key={item.id_menu} className=" w-full bg-white/90 rounded-sm shadow-md border-1 border-blue-100 p-4 hover:shadow-xl transition-all dark:bg-slate-900">
